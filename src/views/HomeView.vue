      ...
      <div class="grid grid-cols-2 gap-3">
        ...
        >
          <div class="w-12 h-12 bg-primary-100 rounded-lg flex items-center justify-center mb-2">
            <svg v-if="action.icon === 'test'" class="w-6 h-6 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <svg v-if="action.icon === 'image'" class="w-6 h-6 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
